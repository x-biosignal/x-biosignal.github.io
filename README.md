...
Documentation portal for the 37-package
...
- R is the released implementation and currently includes 37 packages.
...
- `llms.txt`, structured data, and the MCP section must retain all 37 released
